...
const toPictureImage = (file: string) =>
  `/assets/language_arts/consonant_blend/consonant_blend_picture_cards_drawings/${file}`;
...
export default function ConsonantBlendPhonicLabelsLesson() {
    ...
    const loadFiles = async () => {
      try {
        const [labelsResponse, picturesResponse] = await Promise.all([
          ...
          fetch("/api/language-arts/consonant-blends/cards-drawings", { cache: "no-store" }),
        ]);
  ...
  useEffect(() => {
    trackLessonEvent({
      lesson: "language-arts:consonant-blends:phonic-labels-illustrated",
      ...
      <div className="relative min-h-screen bg-[radial-gradient(circle_at_top,#eef6ff,#f9fcff_55%,#f3f8ff)]">
        ...
        <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col items-center justify-center gap-6 px-6 py-10 text-center">
          ...
          <p className="max-w-2xl text-sm text-stone-600">
            ...
            and
            {" "}
            <code>/public/assets/language_arts/consonant_blend/consonant_blend_picture_cards_drawings</code>.
          </p>
        </main>
      </div>
    );
    ...
    <div className="relative min-h-screen bg-[radial-gradient(circle_at_top,#eef6ff,#f9fcff_55%,#f3f8ff)]">
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-8 px-6 py-10">
        <header className="space-y-3 text-center">
          <p className="text-xs uppercase tracking-[0.35em] text-stone-400">
            Consonant Blend Illustrated Cards · Blend {activeBlend.toUpperCase()}
          </p>
      ...
      <CompletionOverlay
        ...
        primaryAction={
          nextBlend
            ? {
                href: `/lessons/language-arts/consonant-blends/phonic-labels-illustrated/${nextBlend}`,
        ...
        secondaryAction={{ href: "/lessons/language-arts/consonant-blends/phonic-labels-illustrated", label: "All Blends" }}
      />
    </div>
  );
}
