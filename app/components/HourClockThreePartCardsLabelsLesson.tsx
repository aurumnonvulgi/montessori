...
export default function HourClockThreePartCardsLabelsLesson() {
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-8 px-6 py-10">
        <header className="space-y-3 text-center">
          <p className="text-xs uppercase tracking-[0.35em] text-stone-400">
            History &amp; Time · Hour Clock Three-Part Cards Labels
          </p>
          <h1 className="font-display text-4xl font-semibold text-stone-900">Hour Clock Three-Part Cards Labels</h1>
