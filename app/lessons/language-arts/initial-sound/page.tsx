      ...
      <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-8 px-6 py-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            ...
            <ImageGridPreview images={tracingImages} className="bg-rose-50/70" />
            <p className="text-xs uppercase tracking-[0.35em] text-rose-700">Sneak peek – SVG assets coming soon</p>
          </Link>
        </div>
      </main>
    </div>
