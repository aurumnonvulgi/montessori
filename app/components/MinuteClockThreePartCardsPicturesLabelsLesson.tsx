...
type MinuteClockThreePartCardsPicturesLabelsLessonProps = {
  chunkSlug: string;
};

export default function MinuteClockThreePartCardsPicturesLabelsLesson({
  chunkSlug,
}: MinuteClockThreePartCardsPicturesLabelsLessonProps) {
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-8 px-6 py-10">
        <header className="space-y-3 text-center">
          <p className="text-xs uppercase tracking-[0.35em] text-stone-400">
            History &amp; Time · Minute Clock Three-Part Cards Pictures &amp; Labels
          </p>
          <h1 className="font-display text-4xl font-semibold text-stone-900">
            Minute Clock Three-Part Cards Pictures &amp; Labels
          </h1>
          <p className="text-sm text-stone-600">
            {selectedChunk.label} • Drag each picture and label to the matching full minute card.
          </p>
        </header>
