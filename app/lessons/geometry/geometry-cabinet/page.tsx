...
export default function GeometryCabinetPage() {
  return (
    <div className="relative min-h-screen bg-[radial-gradient(circle_at_top,#ecfeff,#f7fbff_55%,#eefcff)]">
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-8 px-6 py-10">
        <header className="space-y-3 text-center">
          ...
          <h1 className="font-display text-4xl font-semibold text-slate-900">Geometry Cabinet</h1>
          <p className="text-sm text-slate-600">Choose a tray to begin.</p>
        </header>

        <section className="grid gap-6 md:grid-cols-2">
          <Link
            href="/lessons/geometry/geometry-cabinet/first-tray"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-display text-2xl font-semibold text-slate-900">First Tray</h2>
            </div>

            <GeometryCabinetFirstTrayScene preview className="h-24" />

            <p className="text-xs uppercase tracking-[0.35em] text-cyan-700">Tray 1</p>
